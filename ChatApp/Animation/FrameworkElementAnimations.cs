...
namespace ChatApp
{
    ...
    public static class FrameworkElementAnimations
    {
        ...
        /// <returns></returns>
        public static async Task SlideAndFadeInAsync(this FrameworkElement element, AnimationSlideInDirection direction, bool firstLoad, float seconds = 0.3f, bool keepMargin = true, int size = 0, bool fadeIn = true)
        {
